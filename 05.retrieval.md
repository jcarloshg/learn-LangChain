# 🔍 Best Practices & Tips for Managing Retrieval in LangChain
...
### Part 1: Best Practices for Retrieval Management
1. [Choose the Right Document Loader](#1-choose-the-right-document-loader-for-your-data) - Line 9
2. [Implement Proper Document Splitting](#2-implement-proper-document-splitting) - Line 87
3. [Choose the Right Vector Store](#3-choose-the-right-vector-store) - Line 172
4. [Implement Proper Embeddings Strategy](#4-implement-proper-embeddings-strategy) - Line 270
5. [Build Effective Retrievers](#5-build-effective-retrievers) - Line 387
6. [Build Production-Ready RAG Chains](#6-build-production-ready-rag-chains) - Line 508
7. [Implement Metadata Management](#7-implement-metadata-management) - Line 643
8. [Implement Retrieval Evaluation and Monitoring](#8-implement-retrieval-evaluation-and-monitoring) - Line 736
9. [Implement Efficient Indexing and Caching](#9-implement-efficient-indexing-and-caching) - Line 855
10. [Implement Multi-Index Retrieval](#10-implement-multi-index-retrieval) - Line 964

### Part 2: Tips & Tricks for Retrieval
1. [Implement Hybrid Search (Dense + Sparse)](#trick-1-implement-hybrid-search-dense--sparse) - Line 1063
2. [Implement Query Expansion](#trick-2-implement-query-expansion) - Line 1119
3. [Implement Re-ranking](#trick-3-implement-re-ranking) - Line 1165
4. [Implement Contextual Retrieval](#trick-4-implement-contextual-retrieval) - Line 1219
5. [Implement Dynamic k Selection](#trick-5-implement-dynamic-k-selection) - Line 1268
6. [Implement Lost-in-Middle Detection](#trick-6-implement-lost-in-middle-detection) - Line 1314
7. [Implement Retrieval Caching](#trick-7-implement-retrieval-caching) - Line 1353
8. [Implement Retrieval with Fallback](#trick-8-implement-retrieval-with-fallback) - Line 1406
9. [Implement Diversity-Aware Retrieval](#trick-9-implement-diversity-aware-retrieval) - Line 1442
10. [Implement Adaptive Retrieval](#trick-10-implement-adaptive-retrieval) - Line 1501

### Quick Reference & Checklists
- [Quick Reference: Retrieval Methods](#-quick-reference-retrieval-methods) - Line 1551
- [Retrieval Optimization Checklist](#-retrieval-optimization-checklist) - Line 1569
- [Production Retrieval Checklist](#-production-retrieval-checklist) - Line 1587
...
# ✅ 3. CSVLoader - CSV files with structured data
...
# ✅ 5. WebBaseLoader - Web pages
web_loader = WebBaseLoader(
    web_path="https://example.com"
)
docs = web_loader.load()

# ✅ 6. DirectoryLoader - Multiple files in directory
...
# ✅ 7. UnstructuredFileLoader - Automatic format detection
...
# ✅ 1. RecursiveCharacterTextSplitter - Best for most cases
...
# ✅ 2. TokenTextSplitter - Split by tokens (more accurate for LLMs)
...
# ✅ 3. MarkdownHeaderTextSplitter - Preserve markdown structure
...
# ✅ 1. FAISS - Fast, local, good for development
...
# ✅ 2. Chroma - Easy to use, persistent
...
# ✅ 4. Weaviate - Open source, production-ready
...
# ✅ 1. OpenAI Embeddings - Most reliable, paid
...
# ✅ 3. Sentence Transformers - Specialized embeddings
...
# ✅ Caching embeddings for cost savings
import pickle
import hashlib
...
# ✅ 2. BM25Retriever - Keyword/sparse search
bm25_retriever = BM25Retriever.from_documents(docs)

# ✅ 3. Ensemble Retriever - Combine dense and sparse
ensemble_retriever = EnsembleRetriever(
    retrievers=[bm25_retriever, vector_retriever],
    weights=[0.5, 0.5]  # Balance between keyword and semantic
)

# ✅ 4. Contextual Compression - Filter irrelevant docs
...
# ✅ 5. Self-Query Retriever - Extract filters from query
...
class LostInMiddleHandler:
    ...
    def invoke_with_rearrangement(self, query: str):
        ...
        # Sort: high relevance → middle, low relevance → edges
        n = len(docs)
...
```
┌────────────────────┬──────────────────┬───────────────┬─────────────┐
│ Retrieval Method   │ Best For         │ Pros          │ Cons        │
├────────────────────┼──────────────────┼───────────────┼─────────────┤
│ Vector Similarity  │ Semantic search  │ Fast, accurate│ Slow to build|
│ BM25               │ Keyword search   │ Fast, simple  │ No semantics│
│ Hybrid (Ensemble)  │ General purpose  │ Balanced      │ Slower      │
│ Contextual         │ Documents        │ Context-aware │ Complex     │
│ Reranking          │ Quality boost    │ Better results│ Extra LLM   │
│ Query Expansion    │ Complex queries  │ Comprehensive │ More calls  │
│ Self-Query         │ Filtered search  │ Intelligent   │ Slower      │
└────────────────────┴──────────────────┴───────────────┴─────────────┘
```
...
**Master retrieval. Build powerful RAG systems. Provide accurate, grounded answers.** 🔍✨
